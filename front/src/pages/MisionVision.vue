<template>
  <q-page class="q-pa-lg text-justify"
    ...
    <div class="text-subtitle2">El Colegio Alemán es un modelo en la sociedad boliviana donde los alumnos y alumnas son formados en valores, con una preparación sólida en conocimientos críticos, reflexivos, creativos y con autonomía en sus decisiones.</div><br>
    <div class="text-subtitle2">Los docentes son los mediadores comprometidos con una acción encaminada a ser luz y guía de sus educandos. La familia contribuye permanentemente en la labor de formación de sus hijos, para lograr un modelo de egresados, formados en calidad y excelencia al servicio de la sociedad.</div><br>
  </q-page>
</template>
